        ...
        await qrRef.current.start(
          ...
          async ( decodedText ) => {
            ...
            try {
              ...
              // QR now contains ONLY the registration number
              ...
              const payload = {
                ...
                lecturer_name:
                  session.lecturer_name || "Lecturer",
              ...
              if ( response.data.success ) {
                ...
                // Student data returned from backend
                setStudent( {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-xl mx-auto bg-white p-6 rounded-xl shadow">
        ...
        {message && (
          <div
            className={`mt-4 p-3 rounded text-center font-semibold ${messageType === "success"
